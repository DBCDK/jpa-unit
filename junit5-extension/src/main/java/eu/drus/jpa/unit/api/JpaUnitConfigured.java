...
public class JpaUnitConfigured implements BeforeAllCallback, AfterAllCallback, BeforeEachCallback, AfterEachCallback {
    ...
    public JpaUnitConfigured(PropertyCreatingBlock block) {
        this.propertyCreatingBlock= block;
    }
    ...
    private TestInvocation createTestMethodInvocation(final ExtensionContext context, final boolean considerExceptions) {
        final Map<String, Object> properties = new HashMap<>(propertyCreatingBlock.create());
